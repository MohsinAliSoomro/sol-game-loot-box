...
import { useProjectLootboxes } from '@/lib/hooks/useProjectLootboxes';
...
export default function Settings() {
  ...
  const { lootboxes, loading, error, addLootbox, updateLootbox, deleteLootbox } = useProjectLootboxes();
  const [showAddModal, setShowAddModal] = useState(false);
  const [selectedType, setSelectedType] = useState('lootbox');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Maximum lootbox limit reached. This project allows a maximum of 2 lootboxes. You currently have 2');
    }
  };
              ...
              {loading ? (
                ...
                lootboxes.map((item) => (
                  <tr
                    ...
                    onClick={() => router.push(`/${projectSlug}/${adminSlug}/lootbox/${item.id}/rewards`)}
                  >
